...
@dataclass
class MAPGTrustRegionClippingPolicyLossSeparateNetworksConfig:
    clipping_epsilon: float = 0.2
    entropy_cost: float = 0.01


class MAPGWithTrustRegionClippingPolicyLossSeparateNetworks(Loss):
    def __init__(
        self,
        config: MAPGTrustRegionClippingPolicyLossSeparateNetworksConfig = MAPGTrustRegionClippingPolicyLossSeparateNetworksConfig(),  # noqa: E501
    ):
        """Component defines a MAPGWithTrustRegionClipping loss function.
    ...
    def config_class() -> Optional[Callable]:
        ...
        Returns:
            config class/dataclass for component.
        """
        return MAPGTrustRegionClippingPolicyLossSeparateNetworksConfig
...
@dataclass
class MAPGTrustRegionClippingValueLossSeparateNetworksConfig:
    value_clip_parameter: float = 0.2
    clip_value: bool = True
    value_cost: float = 0.5


class MAPGWithTrustRegionClippingValueLossSeparateNetworks(Loss):
    def __init__(
        self,
        config: MAPGTrustRegionClippingValueLossSeparateNetworksConfig = MAPGTrustRegionClippingValueLossSeparateNetworksConfig(),  # noqa: E501
    ):
        """Component defines a MAPGWithTrustRegionClipping loss function.
    ...
    def config_class() -> Optional[Callable]:
        ...
        Returns:
            config class/dataclass for component.
        """
        return MAPGTrustRegionClippingValueLossSeparateNetworksConfig
...
@dataclass
class MAPGTrustRegionClippingValueHuberLossSeparateNetworksConfig:
    value_clip_parameter: float = 0.2
    clip_value: bool = True
    value_cost: float = 0.5


class MAPGWithTrustRegionClippingValueHuberLossSeparateNetworks(Loss):
    def __init__(
        self,
        config: MAPGTrustRegionClippingValueHuberLossSeparateNetworksConfig = MAPGTrustRegionClippingValueHuberLossSeparateNetworksConfig(),  # noqa: E501
    ):
        """Component defines a MAPGWithTrustRegionClipping loss function.
    ...
    def config_class() -> Optional[Callable]:
        ...
        Returns:
            config class/dataclass for component.
        """
        return MAPGTrustRegionClippingValueHuberLossSeparateNetworksConfig
