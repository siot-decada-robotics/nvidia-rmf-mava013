...
from mava.systems.vdn.components import training as vdn_training


class VDNSystem(System):
    @staticmethod
    def design() -> Tuple[DesignSpec, Any]:
        """System design for VDN.

        Args:
            None.

        Returns:
            system: design spec for VDN
            default_params: default VDN configuration
        """
        ...
        trainer_process = DesignSpec(
            ...
            loss=vdn_training.VDNLoss,
            sgd_step=vdn_training.VDNStep,
