...
def main(_: Any) -> None:
    """Example running feedforward IPPO on SMAC environment. Hyperparameters follows closely to https://github.com/marlbenchmark/on-policy."""
